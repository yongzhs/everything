...
class MainWindow(QDialog):
    ...
    def createTxBox(self):
        ...
        m_txFormLayout.addRow(self.m_testMode)
        ...
        self.m_connectPort.clicked.connect(lambda: self.m_serialPort.slot_connect(self))
        self.m_disconnectPort.clicked.connect(lambda: self.m_serialPort.slot_disconnect(self))
